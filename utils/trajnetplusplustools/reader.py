...
class Reader_jrdb_2dbox(object):
    ...
    def paths_to_xy(paths):
        ...
        pedestrians = set(
            row.pedestrian for path in paths for row in path if row.frame in frames
        )
        ...
        primay_pedestrian = paths[0][0].pedestrian
        ...
        return xy, frames, primay_pedestrian
    ...
    def scene(self, scene_id, total_joints_dim=66):
        ...
        track_rows = [
            r for frame in frames for r in self.tracks_by_frame.get(frame, [])
        ]
